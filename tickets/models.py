...
class TicketLetter(TimeStampedMixin):
    ...
    user = models.ForeignKey(User, on_delete = models.SET_NULL, related_name="ticket_letter_user", null = True)
...
class TicketEnvelope(TimeStampedMixin):
    ...
    user = models.ForeignKey(User, on_delete = models.SET_NULL, null = True, related_name='ticket_envelop_user', verbose_name=_('TicketEnvelopUser'))
...
class Attachment(models.Model): #1 to many
    ...
    ticket = models.ForeignKey("TicketEnvelope", on_delete = models.CASCADE)
